...
def kamala_reply(text):
    ...
    try:
        if 'কমলা' in text or 'কমলার' in text:
            ...
            elif 'লাইট' in text and 'জ্বালাও' in text:
                home_automation.led_on()
                kamala_talk('লাইট জ্বালিয়েছি ')
            elif 'লাইট' in text and 'বন্ধ' in text:
                home_automation.led_off()
                kamala_talk('লাইট বন্ধ করেছি  ')
            elif 'ফ্যান চালাও' in text or 'ফ্যান ছাড়ো' in text:
                home_automation.fan_on()
                kamala_talk('ফ্যান চালিয়েছি ')
            elif 'ফ্যান বন্ধ' in text:
                home_automation.fan_off()
                kamala_talk('ফ্যান বন্ধ করেছি ')
            # google translator
            elif 'অনুবাদ' in text or 'অনুভব' in text:
